...
class UserProfile(Base):
    ...
    work_status_uk: Mapped[str | None] = mapped_column(String(120))
    salary_expectation: Mapped[str | None] = mapped_column(String(120))
    travel_distance: Mapped[str | None] = mapped_column(String(120))
    availability_notice: Mapped[str | None] = mapped_column(String(80))
    salary_expectation_gbp: Mapped[int | None] = mapped_column(Integer)
    travel_distance_miles: Mapped[int | None] = mapped_column(Integer)
    minimum_apply_score: Mapped[int] = mapped_column(Integer, default=80, server_default="80", nullable=False)
...
class ApplicationPrepareRun(Base):
    __tablename__ = "application_prepare_runs"
    ...
    queued: Mapped[int] = mapped_column(Integer, default=0, server_default="0", nullable=False)
    skipped: Mapped[int] = mapped_column(Integer, default=0, server_default="0", nullable=False)
    failed: Mapped[int] = mapped_column(Integer, default=0, server_default="0", nullable=False)
    error: Mapped[str | None] = mapped_column(Text)
    started_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), server_default=func.now(), nullable=False)
...
class JobAvailabilityRun(Base):
    __tablename__ = "job_availability_runs"
